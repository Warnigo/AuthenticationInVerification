        ...
        <div className="login">
            <section className="bg-gray-50 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <Link to={"/"} className="flex items-center mb-6 text-3xl font-semibold text-gray-900 dark:text-white font-black">
                        Warnigo
                    </Link>
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            {errorMessage && <p className="bg-red-500 text-white">{errorMessage}</p>}
                            <form className="space-y-4 md:space-y-6" onSubmit={handleRegister}>
                                ...
                                <div className="flex">
                                    ...
                                    >
                                        <svg className="mr-0 -ml-1 w-4 h-4" aria-hidden="true" focusable="false"
